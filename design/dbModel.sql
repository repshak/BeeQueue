...
CREATE TABLE NN_SPAWN (
       DOMAIN_CD VARCHAR(32) NOT NULL
     , MSG_KIND VARCHAR(1024) NOT NULL
     , SPAWN_INFO VARCHAR(4000) NOT NULL
     , LOCK_TS TIMESTAMP NOT NULL
     , LAST_MSG_ID BIGINT NOT NULL
     , CONSTRAINT PK_NN_SPAWN PRIMARY KEY (MSG_KIND, DOMAIN_CD)
);
...
ALTER TABLE NN_SPAWN
  ADD CONSTRAINT FK_NN_SPAWN_1
      FOREIGN KEY (DOMAIN_CD)
      REFERENCES NN_DOMAIN (DOMAIN_CD);

ALTER TABLE NN_SPAWN
  ADD CONSTRAINT FK_NN_SPAWN_2
